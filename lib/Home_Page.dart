...
//Applying get request.
  ...
  Widget expenseTile(
      var value, String note, DateTime date, var index, snap, String category) {
    return InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            LinearPercentIndicator(
              ...
              //center: budget_limit == '500' ?  Text("100%") : Text("0%"),
              progressColor: Colors.red.shade900,
              linearStrokeCap: LinearStrokeCap.roundAll,

              center: value >= 100 && value <200
                  ? Text("${get_percentage = '20'}%")
                  : value >= 200 && value <400
                      ? Text("${get_percentage = '40'}%")
                      : value >= 400 && value <600
                          ? Text("${get_percentage = '60'}%")
                          : value >= 600 && value <800
                              ? Text("${get_percentage = '80'}%")
                              : Text(""),
            ),

            category == 'shopping' && value == 2000 ? Text( "Budget exceeded") :SizedBox(height: 5,),

           // category == 'shopping' ? Text(value+value):Text("jmj"),
